...
{
	WiimoteHid::WiimoteHid(WiimoteCallback* callback) :
			Wiimote(callback),
			m_buttonState(0)
	{
	...
	void WiimoteHid::WriteReport(u8 reportId, u8* reportData, size_t reportLength)
	{
