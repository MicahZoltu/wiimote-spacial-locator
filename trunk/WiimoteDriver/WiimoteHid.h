...
namespace WiimoteDriver
{
	...
	class WiimoteHid : public Wiimote
	{
	public:
		WiimoteHid(WiimoteCallback* callback);
	...
	private:
		// We keep track of button state inside the WiimoteHid so we can make the appropriate callbacks
		u16 m_buttonState;
	};
}
